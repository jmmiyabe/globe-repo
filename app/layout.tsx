...
import NavbarWrapper from "@/components/navigation/navbar-wrapper" // ✅ client component
  ...
  return (
    <html lang="en">
      ...
      <body className="font-sans antialiased">
        ...
        {children}
        <Analytics />
        <Script src="https://api.windy.com/assets/map-forecast/libBoot.js" strategy="afterInteractive" />
      </body>
    </html>
  )
}
