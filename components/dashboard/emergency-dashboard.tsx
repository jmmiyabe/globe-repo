...
import { AlertTriangle, MapPin, AlertCircle, Phone, MessageSquare } from "lucide-react"
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-3xl md:text-4xl font-bold text-foreground">Weather Response Command Center</h1>
          </div>
          <p className="text-muted-foreground">Real-time emergency coordination and response management</p>
        </div>
        ...
        <Card className="bg-card border-border mb-6">
          <CardHeader>
            ...
            <CardDescription>Activate emergency services and notify communities</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card className="bg-card border-border">
          <CardHeader>
            ...
            <CardDescription>Recommended evacuation and access routes</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-3">
              {[
                ...
                <div key={i} className="flex items-center justify-between p-3 bg-muted rounded-lg">
                  ...
                  <div className="flex items-center gap-3">
                    <StatusBadge level={item.status === "CLEAR" ? "safe" : "warning"} label={item.status} />
