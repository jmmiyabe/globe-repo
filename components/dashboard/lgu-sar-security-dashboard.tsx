...
const crimeWarnings: CrimeWarning[] = [
  {
    ...
    severity: "high",
    description: "Reported looting at commercial establishments during evacuation",
    ...
    <div className="min-h-screen bg-background p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-muted-foreground mt-2">Real-time search and rescue reports and crime warnings</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          <Card className="bg-card border-border">
            <CardHeader className="pb-3">
              <CardTitle className="text-sm font-medium text-muted-foreground">Active SAR Operations</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card className="bg-card border-border">
            <CardHeader className="pb-3">
              <CardTitle className="text-sm font-medium text-muted-foreground">Personnel Deployed</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card className="bg-card border-border">
            <CardHeader className="pb-3">
              <CardTitle className="text-sm font-medium text-muted-foreground">Active Crime Warnings</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <CardContent>
            <div className="space-y-4">
              {sarReports.map((report) => (
                <div key={report.id} className={`p-4 rounded-lg border ${getPriorityColor(report.priority)}`}>
                  <div className="flex items-start justify-between mb-3">
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-1">
                        <h3 className="font-semibold text-foreground">{report.id}</h3>
                        <Badge
                          className={`${
                  ...
                  <div className="grid grid-cols-3 md:grid-cols-4 gap-4 text-sm">
                    <div>
                      ...
                      <p className="font-semibold capitalize">{report.type.replace("_", " ")}</p>
                    </div>
                    <div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        <Badge
                          className={`${
                            warning.status === "active" ? "bg-red-500/30 text-red-300" : "bg-gray-500/30 text-gray-300"
                          }`}
                        >
                          {warning.status}
                        </Badge>
