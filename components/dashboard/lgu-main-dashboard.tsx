...
const AlertTrendChartDynamic = dynamic(
  () => Promise.resolve(AlertTrendChartInner),
  {
    ssr: false,
    loading: () => (
      ...
      <div class="marker-center ${kind}-center">
        ${
          markerType === "critical"
            ...
            : markerType === "shelter"
            ? `<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="text-white"><path d="m3 9 9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>`
            : markerType === "resource"
            ? `<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="text-white"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>`
  ...
  return (
    <Card className="border-border lg:col-span-2">
      ...
      <CardContent>
        <div className="mb-4 flex items-center gap-2">
          <button
            ...
            className={`px-3 py-1 rounded ${
              selectedTab === "zone" ? "bg-primary text-white" : "bg-muted"
            }`}
          >
            Zone View
          </button>
          <button
            ...
            className={`px-3 py-1 rounded ${
              selectedTab === "barangay" ? "bg-primary text-white" : "bg-muted"
            }`}
          >
            Barangay View
          </button>
          <button
            ...
            className={`px-3 py-1 rounded ${
              selectedTab === "city" ? "bg-primary text-white" : "bg-muted"
            }`}
          >
            City View
          </button>
        ...
        <div
          className="relative w-full h-[500px] rounded-lg overflow-hidden border border-border"
          style={{ zIndex: 0 }}
        >
          <MapContainer
            center={center}
          ...
          <div
            className="absolute bottom-4 left-4 bg-slate-800/90 backdrop-blur px-4 py-3 rounded-lg border border-slate-700"
            style={{ zIndex: 1000 }}
          >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-1 gap-8">
          <Card className="border-border">
            <CardHeader>
              ...
              <CardDescription>
                Historical critical and warning alerts over the last 24 hours
              </CardDescription>
            </CardHeader>
            <CardContent>
              <AlertTrendChart />{" "}
              {/* Renders the dynamically loaded AlertTrendChartDynamic */}
            </CardContent>
          </Card>
        </div>
      </div>
