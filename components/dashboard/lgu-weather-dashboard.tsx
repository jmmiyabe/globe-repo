...
const initialAreas: AreaWeather[] = [
  { area: "Malibay", lat: 14.548, lon: 120.995, condition: "", temp: 0, humidity: 0, windSpeed: 0, visibility: 0, alert: "safe" },
  { area: "Baclaran", lat: 14.537, lon: 120.999, condition: "", temp: 0, humidity: 0, windSpeed: 0, visibility: 0, alert: "safe" },
  { area: "Maricaban", lat: 14.540, lon: 120.993, condition: "", temp: 0, humidity: 0, windSpeed: 0, visibility: 0, alert: "safe" },
  { area: "Pasay City Hall Area", lat: 14.556, lon: 120.998, condition: "", temp: 0, humidity: 0, windSpeed: 0, visibility: 0, alert: "safe" },
  { area: "Villamor Air Base", lat: 14.530, lon: 120.996, condition: "", temp: 0, humidity: 0, windSpeed: 0, visibility: 0, alert: "safe" },
]
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <Card className="bg-card border-l-4 border-yellow-500/50">
            <CardHeader className="pb-2">
              <CardTitle className="text-sm text-muted-foreground">Warning Areas</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card className="bg-card border-l-4 border-green-500/50">
            <CardHeader className="pb-2">
              <CardTitle className="text-sm text-muted-foreground">Safe Areas</CardTitle>
            </CardHeader>
            <CardContent>
        ...
        <Card className="bg-card border-border">
          <CardHeader>
            ...
            <CardDescription>Live wind and weather conditions for Philippines.</CardDescription>
          </CardHeader>
        ...
        <Card className="bg-card border-border">
          ...
          <CardContent className="space-y-4">
            {areas.map((area) => (
              <div
                key={area.area}
                className={`p-4 rounded-lg border ${getAlertColor(area.alert)} flex flex-col md:flex-row items-start md:items-center justify-between gap-4`}
              >
